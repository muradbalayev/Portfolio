    ...
    return (
        <section id="skills" className='skills-section w-full mx-auto flex flex-col items-center py-10'>
            ...
            <div className='skills w-4/5 p-4 mt-10 mx-auto flex flex-wrap justify-center items-center border rounded-3xl border-slate-400 gap-4 shadow-md'>
                ...
                <div className='skills-container  py-2 px-5 border border-slate-400 rounded-2xl w-32 h-16 flex justify-center items-center gap-1'>
                ...
                <div className='skills-container  py-2 px-5 border border-slate-400 rounded-2xl h-16 flex justify-center items-center gap-2'>
                    <img src={material} alt='skill' width={35} />
                    <p className=' font-semibold'>MaterialUI</p>
                </div>
            </div>
